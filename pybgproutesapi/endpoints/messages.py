...
def messages(
    ...
    params = {
        ...
        "aspath_negative_regexp": aspath_negative_regexp,
        "aspath_exact_match": _csv(aspath_exact_match),
        "community_regexp": community_regexp,
        "community_negative_regexp": community_negative_regexp,
